...
import deprecated.an.xacml.context.*;
import deprecated.an.xacml.policy.*;
import deprecateed.an.xacml.adapter.file.context.*;
import deprecateed.an.xacml.adapter.file.policy.*;
...
public abstract class XMLFileDataAdapterRegistry {
    ...
    static {
        ...
        policyByXMLTag.put(POLICY_TAG_ACTION, deprecateed.an.xacml.adapter.file.policy.FileAdapterAction.class);
        ...
        policyByXMLTag.put(POLICY_TAG_ENVIRONMENT, deprecateed.an.xacml.adapter.file.policy.FileAdapterEnvironment.class);
        ...
        policyByXMLTag.put(POLICY_TAG_RESOURCE, deprecateed.an.xacml.adapter.file.policy.FileAdapterResource.class);
        ...
        policyByXMLTag.put(POLICY_TAG_SUBJECT, deprecateed.an.xacml.adapter.file.policy.FileAdapterSubject.class);
        ...
        contextByXMLTag.put(CONTEXT_TAG_ACTION, deprecateed.an.xacml.adapter.file.context.FileAdapterAction.class);
        contextByXMLTag.put(CONTEXT_TAG_ATTRIBUTE, FileAdapterAttribute.class);
        contextByXMLTag.put(CONTEXT_TAG_ENVIRONMENT, deprecateed.an.xacml.adapter.file.context.FileAdapterEnvironment.class);
        ...
        contextByXMLTag.put(CONTEXT_TAG_RESOURCE, deprecateed.an.xacml.adapter.file.context.FileAdapterResource.class);
        contextByXMLTag.put(CONTEXT_TAG_SUBJECT, deprecateed.an.xacml.adapter.file.context.FileAdapterSubject.class);
        ...
        policyByXACMLElement.put(deprecated.an.xacml.policy.Action.class, deprecateed.an.xacml.adapter.file.policy.FileAdapterAction.class);
        ...
        policyByXACMLElement.put(deprecated.an.xacml.policy.Environment.class, deprecateed.an.xacml.adapter.file.policy.FileAdapterEnvironment.class);
        ...
        policyByXACMLElement.put(deprecated.an.xacml.policy.Resource.class, deprecateed.an.xacml.adapter.file.policy.FileAdapterResource.class);
        ...
        policyByXACMLElement.put(deprecated.an.xacml.policy.Subject.class, deprecateed.an.xacml.adapter.file.policy.FileAdapterSubject.class);
        ...
        contextByXACMLElement.put(deprecated.an.xacml.context.Action.class, deprecateed.an.xacml.adapter.file.context.FileAdapterAction.class);
        contextByXACMLElement.put(Attribute.class, FileAdapterAttribute.class);
        contextByXACMLElement.put(deprecated.an.xacml.context.Environment.class, deprecateed.an.xacml.adapter.file.context.FileAdapterEnvironment.class);
        ...
        contextByXACMLElement.put(deprecated.an.xacml.context.Resource.class, deprecateed.an.xacml.adapter.file.context.FileAdapterResource.class);
        contextByXACMLElement.put(deprecated.an.xacml.context.Subject.class, deprecateed.an.xacml.adapter.file.context.FileAdapterSubject.class);
