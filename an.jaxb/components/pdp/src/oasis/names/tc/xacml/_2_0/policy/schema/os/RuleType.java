...
@XmlType(name = "RuleType", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os", propOrder = {
    "description",
    "target",
    "condition"
})
public class RuleType {
    ...
    @XmlElement(name = "Target", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os")
    protected TargetType target;
    @XmlElement(name = "Condition", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os")
