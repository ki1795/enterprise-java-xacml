...
@XmlType(name = "PolicySetType", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os", propOrder = {
    "description",
    "policySetDefaults",
    "target",
...
public class PolicySetType {
    ...
    @XmlElement(name = "PolicySetDefaults", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os")
