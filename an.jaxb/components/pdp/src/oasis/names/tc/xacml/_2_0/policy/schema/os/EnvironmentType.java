...
@XmlType(name = "EnvironmentType", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os", propOrder = {
    "environmentMatch"
})
public class EnvironmentType {

    @XmlElement(name = "EnvironmentMatch", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os", required = true)
