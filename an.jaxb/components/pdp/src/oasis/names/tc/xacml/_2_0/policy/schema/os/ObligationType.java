...
@XmlType(name = "ObligationType", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os", propOrder = {
    "attributeAssignment"
})
public class ObligationType {

    @XmlElement(name = "AttributeAssignment", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os")
