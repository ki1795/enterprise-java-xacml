...
@XmlType(name = "EnvironmentsType", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os", propOrder = {
    "environment"
})
public class EnvironmentsType {

    @XmlElement(name = "Environment", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os", required = true)
