...
@XmlType(name = "MissingAttributeDetailType", namespace = "urn:oasis:names:tc:xacml:2.0:context:schema:os", propOrder = {
    "attributeValue"
})
public class MissingAttributeDetailType {

    @XmlElement(name = "AttributeValue", namespace = "urn:oasis:names:tc:xacml:2.0:context:schema:os")
