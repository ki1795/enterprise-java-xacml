...
@XmlType(name = "ResourcesType", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os", propOrder = {
    "resource"
})
public class ResourcesType {

    @XmlElement(name = "Resource", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os", required = true)
