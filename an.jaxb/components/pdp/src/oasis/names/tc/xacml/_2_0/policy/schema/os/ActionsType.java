...
@XmlType(name = "ActionsType", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os", propOrder = {
    "action"
})
public class ActionsType {

    @XmlElement(name = "Action", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os", required = true)
