...
@XmlType(name = "PolicyType", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os", propOrder = {
    "description",
    "policyDefaults",
    "combinerParameters",
    "target",
...
public class PolicyType implements PolicyNamespaceResolver {
    ...
    @XmlElements({
        @XmlElement(name = "RuleCombinerParameters", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os", type = RuleCombinerParametersType.class),
        @XmlElement(name = "VariableDefinition", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os", type = VariableDefinitionType.class),
        ...
        @XmlElement(name = "Rule", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os", type = RuleType.class)
    })
