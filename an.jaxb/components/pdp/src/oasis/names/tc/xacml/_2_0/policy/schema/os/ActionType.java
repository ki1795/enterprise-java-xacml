...
@XmlType(name = "ActionType", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os", propOrder = {
    "actionMatch"
})
public class ActionType {

    @XmlElement(name = "ActionMatch", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os", required = true)
