...
@XmlType(name = "TargetType", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os", propOrder = {
    "subjects",
    "resources",
    "actions",
    "environments"
...
public class TargetType {
    ...
    @XmlElement(name = "Subjects", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os")
    protected SubjectsType subjects;
    @XmlElement(name = "Resources", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os")
    protected ResourcesType resources;
    @XmlElement(name = "Actions", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os")
    protected ActionsType actions;
    @XmlElement(name = "Environments", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os")
