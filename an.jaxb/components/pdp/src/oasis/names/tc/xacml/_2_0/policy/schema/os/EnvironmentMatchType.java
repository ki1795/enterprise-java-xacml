...
@XmlType(name = "EnvironmentMatchType", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os", propOrder = {
    "attributeValue",
...
public class EnvironmentMatchType {
    ...
    @XmlElement(name = "EnvironmentAttributeDesignator", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os")
