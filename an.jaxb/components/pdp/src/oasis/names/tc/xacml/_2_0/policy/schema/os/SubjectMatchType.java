...
@XmlType(name = "SubjectMatchType", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os", propOrder = {
    "attributeValue",
...
public class SubjectMatchType {
    ...
    @XmlElement(name = "SubjectAttributeDesignator", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os")
