...
@XmlType(name = "AttributeType", namespace = "urn:oasis:names:tc:xacml:2.0:context:schema:os", propOrder = {
    "attributeValue"
})
public class AttributeType {

    @XmlElement(name = "AttributeValue", namespace = "urn:oasis:names:tc:xacml:2.0:context:schema:os", required = true)
