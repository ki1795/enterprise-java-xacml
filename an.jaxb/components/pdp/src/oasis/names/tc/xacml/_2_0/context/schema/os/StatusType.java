...
@XmlType(name = "StatusType", namespace = "urn:oasis:names:tc:xacml:2.0:context:schema:os", propOrder = {
    "statusCode",
    "statusMessage",
    "statusDetail"
})
public class StatusType {
    ...
    @XmlElement(name = "StatusCode", namespace = "urn:oasis:names:tc:xacml:2.0:context:schema:os", required = true)
    protected StatusCodeType statusCode;
    @XmlElement(name = "StatusMessage", namespace = "urn:oasis:names:tc:xacml:2.0:context:schema:os")
    protected String statusMessage;
    @XmlElement(name = "StatusDetail", namespace = "urn:oasis:names:tc:xacml:2.0:context:schema:os")
