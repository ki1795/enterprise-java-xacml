...
@XmlType(name = "ResultType", namespace = "urn:oasis:names:tc:xacml:2.0:context:schema:os", propOrder = {
    "decision",
    "status",
    "obligations"
})
public class ResultType {
    ...
    @XmlElement(name = "Status", namespace = "urn:oasis:names:tc:xacml:2.0:context:schema:os")
