...
@XmlType(name = "SubjectsType", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os", propOrder = {
    "subject"
})
public class SubjectsType {

    @XmlElement(name = "Subject", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os", required = true)
