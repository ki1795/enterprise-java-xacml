...
@XmlType(name = "CombinerParametersType", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os", propOrder = {
    "combinerParameter"
})
@XmlSeeAlso({
...
public class CombinerParametersType {
    ...
    @XmlElement(name = "CombinerParameter", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os")
