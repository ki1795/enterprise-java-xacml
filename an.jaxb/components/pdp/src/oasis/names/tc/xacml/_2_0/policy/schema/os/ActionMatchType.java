...
@XmlType(name = "ActionMatchType", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os", propOrder = {
    "attributeValue",
...
public class ActionMatchType {
    ...
    @XmlElement(name = "ActionAttributeDesignator", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os")
