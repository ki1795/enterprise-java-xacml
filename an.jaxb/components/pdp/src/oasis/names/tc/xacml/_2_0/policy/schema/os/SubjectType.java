...
@XmlType(name = "SubjectType", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os", propOrder = {
    "subjectMatch"
})
public class SubjectType {

    @XmlElement(name = "SubjectMatch", namespace = "urn:oasis:names:tc:xacml:2.0:policy:schema:os", required = true)
