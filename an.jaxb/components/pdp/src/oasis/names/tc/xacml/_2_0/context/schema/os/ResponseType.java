...
@XmlType(name = "ResponseType", namespace = "urn:oasis:names:tc:xacml:2.0:context:schema:os", propOrder = {
    "result"
})
public class ResponseType {

    @XmlElement(name = "Result", namespace = "urn:oasis:names:tc:xacml:2.0:context:schema:os", required = true)
