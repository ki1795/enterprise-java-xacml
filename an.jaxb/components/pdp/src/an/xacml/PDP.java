...
import static an.xacml.PDPStatus.KEY_RUN_STATUS;
import static an.xacml.PDPStatus.STATUS_RUN_INITIALIZED;
import static an.xacml.PDPStatus.STATUS_RUN_NOTRUN;
import static an.xacml.PDPStatus.STATUS_RUN_RELOADPOLICY;
import static an.xacml.PDPStatus.STATUS_RUN_RUNING;
...
import deprecated.an.xacml.adapter.DataAdapterException;
...
import an.xacml.engine.PolicyLoaderRegistry;
import an.xacml.engine.PolicyResolver;
import an.xacml.engine.PolicyResolverRegistry;
import an.xacml.engine.PolicySyntaxException;
import an.xacml.engine.impl.CacheManager;
import an.xacml.engine.impl.CacheSizeExceedCapacityException;
import an.xacml.engine.impl.DataAdapterPreprocessor;
import an.xacml.engine.impl.DefaultDataStorePolicyResolver;
...
public class PDP extends AbstractMonitorableAndControllable {
    ...
    private BuiltInFunctionRegistry funcReg;
