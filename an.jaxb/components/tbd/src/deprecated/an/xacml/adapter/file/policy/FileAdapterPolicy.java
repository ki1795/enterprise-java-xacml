...
import deprecated.an.xacml.adapter.file.TextXMLElement;
import deprecated.an.xacml.policy.CombinerParameters;
import deprecated.an.xacml.policy.Defaults;
import deprecated.an.xacml.policy.Obligations;
import deprecated.an.xacml.policy.Policy;
import deprecated.an.xacml.policy.Rule;
import deprecated.an.xacml.policy.RuleCombinerParameters;
import deprecated.an.xacml.policy.Target;
import deprecated.an.xacml.policy.VariableDefinition;
